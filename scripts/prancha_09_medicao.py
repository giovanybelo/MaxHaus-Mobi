...
referência, agora separada em laje (2,62) e forro do banheiro (2,40).
"""
import os, sys
...
TAB_CONF = [
    ...
    ('Altura sob o forro', '2,40 m', 'confirmada pelo cliente 21.09', 'o scan já lia 2,40 m'),
    ('Plenum do forro', '0,22 m', 'liberado pela D07', 'fora do banheiro'),
]
...
TAB_DEC = [
    ...
    ('Altura', 'Resolvida', '2,62 na laje, 2,40 sob o forro do banheiro'),
...
def construir():
    ...
    cabecalho(d, 'Base de medição e decisões',
              ...
              '2,62 m na laje  ·  2,40 m sob o forro do banheiro')
    ...
    rodape(d,
           'Volume por ambiente calculado com 2,62 m, exceto o banheiro, com 2,40 m sob o forro. Área de parede conforme o relatório do scan, sem desconto de vão.',
