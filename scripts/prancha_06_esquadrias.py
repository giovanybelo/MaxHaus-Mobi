...
TAB_DADOS = [
    ...
    ('Área de esquadria',              '14,73 m²', 'seis janelas, vão — scan dava 12,70'),
    ...
    ('Pé-direito — forro atual',        '2,40 m',  'plenum de 0,22 m'),
...
NOTAS = [
    ...
    ['**As alturas das janelas vieram do cliente, não do scan.',
     'Cinco têm 1,63 m. A do closet (J06) vai do piso ao teto: 2,40 m de altura livre menos 0,15 m de',
     'apoio no topo e 0,10 m de peitoril, dando 2,00 × 2,15 m — e é o único peitoril medido até agora.',
